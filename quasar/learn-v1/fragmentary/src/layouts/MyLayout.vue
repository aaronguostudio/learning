...
export default {
  ...
  created () {
    console.log('1 - ', this.$q.version)
    console.log('2 - ', this.$q.platform)
    console.log('3 - ', this.$q.screen)
    console.log('4 - ', this.$q.lang)
    console.log('5 - ', this.$q.iconSet)
    console.log('6 - ', this.$q.cordova)
    console.log('7 - ', this.$q.electron)
  }
}
</script>
